...
<div class="container">
    ...
    <div class="row mt-3">
        <div class="col-12">
            <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#addTouristSpotModal">Add Boarding House</button>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addTouristSpotModalLabel">Add Boarding House</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="opening_hours">Curfew Hour:</label>
                    <input type="time" class="form-control" id="opening_hours" name="opening_hours" autocomplete="off" required>
                </div>
                <div class="form-group">
                    <label for="entry_fee">Monthly Rent:</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="edit-form" method="POST" action="{{ route('touristspot.update', ['touristSpot' => $touristSpot->id]) }}">
                        ...
                        <div class="form-group">
                            <label for="opening_hours">Curfew Hours:</label>
